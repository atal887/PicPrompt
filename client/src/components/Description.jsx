...
const Description = () => {
    return (
        <motion.div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'
            ...
            <p className='text-gray-500 mb-8'>Turn your imagination into
                visuals</p>
            <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
                ...
                <div>
                    ...
                    <p className='text-gray-600 mb-4'>Easily bring ypur ideas to life with our free AI
                        image generator. whatever you need stunning visuals or
                        unique imagery,our tool transfotms your text into
